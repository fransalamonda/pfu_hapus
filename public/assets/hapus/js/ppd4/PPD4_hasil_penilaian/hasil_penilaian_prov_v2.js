var main = function(){
    ...
    var datatable = function(){
        ...
        t_bahan.on('click','._btnUplDok',function(){
            ...
            $("#frmDokAdd")[0].reset();
            $('form#frmDokAdd input[name="idwil"]').val(id);
            $('form#frmDokAdd input[name="nama"]').val(nmdok);
            $(".progress-bar").width('0%');
            $(".progress-bar").html('0%');
            $('#mdl_dok_add').modal('show');
           
       });
       t_bahan.on("click","._btnEdtDok",function(e){
            var _self       = $(this);
            var id      = _self.data('maps');
            var nmdok   = _self.data('title');
            $("#frmDokEdt")[0].reset();
            $('form#frmDokEdt input[name="idwil"]').val(id);
