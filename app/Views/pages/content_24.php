...
<form id="frmDokAdd">
    <div id="mdl_dok_add" class="modal modal-action-form fade " tabindex="-1">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card-header card-kiri-dua">
                                    <div class="col-sm-6 col-lg-4 col-xl-12">
                                        ...
                                        <div class="card-kiri-dua-tulisan-dua">Tanpa Sensor, manual valve. Perlu penggantian sparepart merk Sunken Power 2000 Level Epic</div>
                                    </div>
                                    </br>
                                </div>
                                <!-- </div> -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="3" id="example-textarea-input" required="" placeholder="add description"></textarea>
