                        ...
                        <div class="col-lg-12">
                            <div style="display: flex;">
                                <div class="card tombol-aktif _nots" id="_nots">
                                    ...
                                    <button type="button" class="btn b-tombol-aktif nots" id="nots"> Not Started (<a>3</a>)</button>
                                </div>

                                <div class="card tombol-tidakaktif _prog" id="_prog">
                                    <button type="button" class="btn  prog" id="prog">In Progress (<a>100</a>)</button>
                                </div>
                                <div class="card tombol-tidakaktif _comp" id="_comp">
                                    <button type="button" class="btn  comp" id="comp">Completed(<a>5</a>)</button>
                                </div>
                            </div>
                        </div>
                    </div>
